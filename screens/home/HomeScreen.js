        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={handleProfilePress} style={styles.profileContainer}>
            ...
            <View style={styles.profileTextContainer}>
              <Text style={styles.profileName}>Chiao</Text>
          ...
          <View style={styles.headerIcons}>
            ...
            <TouchableOpacity style={styles.iconButton} onPress={() => navigation.navigate('Settings')}>
              <FontAwesome name="cog" size={24} color='#8A2BE2' />
            </TouchableOpacity>
          </View>
        </View>
      ...
      >
        ...
        >
          <View style={styles.modalContainer}>
            <TouchableHighlight
              onPress={() => navigation.navigate('Profile', { name: 'Esau Orit', role: 'Administrator', email: 'chiao@example.com', phone: '123456789', birthday: '08/02/2002' })}
